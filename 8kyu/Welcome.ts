...
// Write a 'welcome' function that takes a parameter 'language', with a type String, and returns a greeting - if
...
export const greet = (language: string): string => {
  ...
  return alphabet[language.toLowerCase()] ? alphabet[language.toLowerCase()] : alphabet['english']
}
