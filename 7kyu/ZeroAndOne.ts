...
//
//   Return the length of the resulting (smallest) string
//   that you can get after applying this operation multiple times?
//
//   Note: after each operation, the remaining digits are
//   separated by spaces and thus not adjacent anymore - see the examples below.
//
//   Examples
...
const zeroAndOne = (s: string): number =>
  /01|10/.test(s)
    ? zeroAndOne(s.replace(/01|10/, '  '))
